  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:scale-105 shadow-medium hover:shadow-strong",
        voice: "bg-gradient-to-r from-accent to-warning text-accent-foreground hover:scale-105 shadow-medium hover:shadow-strong border-2 border-accent/50",
        camera: "bg-gradient-to-r from-primary to-success text-primary-foreground hover:scale-105 shadow-medium hover:shadow-strong border-2 border-primary/50",
      ...
      size: {
        ...
        icon: "h-10 w-10",
        hero: "h-20 rounded-2xl px-16 text-2xl font-bold",
      },
    },
    defaultVariants: {
      variant: "default",
